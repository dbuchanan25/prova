...
echo
    '<center><h1>POSTOPERATIVE DAY #4</h1></center>'.
    '<br>'.
    ...
    '<center><h1>'.$s1['painscore4'].'</h1></center>'.
    ...
    '</svg>'.
    '<br><br>'.
    '<h2><center>Did you take acetaminophen the fourth postoperative day?</center></h2>'.
    ...
    '</svg>'.
    '<br><br>'.
    '<h2><center>Did you take NSAIDS the fourth postoperative day?</center></h2>'.
    ...
    '</svg>'.
    '<br><br>'.
    '<h2><center>Did you take any narcotics the fourth postoperative day?</center></h2>'.
    ...
    if ($s1['method1'] == 'catheter')
    {
        ...
        '</svg>'.
        '<br><br>'.
        '<h2><center>Did you have any drainage from the catheter site on the fourth postoperative day?</center></h2>'.
