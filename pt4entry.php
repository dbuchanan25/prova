...
//Patient entry page for day 4.  This page will be texted to the patient on the appropriate day //
//It forwards information to the page "action_page_pt_day4entry.php"                            //
//////////////////////////////////////////////////////////////////////////////////////////////////
session_start();
...
else
{
    ...
    $q = "SELECT painscore4, id, method1 ".
         "FROM patients ".
    ...
    if ($r !== false)
    {
        ...
        if (isset($_SESSION['again4']) && $_SESSION['again4'])
        {
            $goahead = true;
        }
        if (!$goahead)
        {
            header("Location: ptblock4.php");
        }
    }      
?>
<head>
<title>Day 4 Entry</title>
<meta charset="utf-8">
...
<div class="topnav" style="width:95%; margin-right:auto; margin-left:auto;">
  ...
  <a href="pt4entry.php">Postoperative Day #4</a> 
  ...
  <a href="logout.php">Logout</a>
    ...
    <form action="action_page_pt_day4entry.php" method="post">
