...
$sp = "SELECT a.id, a.fname, a.lname, a.phone, a.email, b.location, c.surgeonFirst, c.surgeonLast, d.first, d.last, ".
             "e.cptDescriptor, e.asaCode, f.block as block1, a.vol1, a.addi1, g.med as med1, h.block as block2, i.med as med2, a.vol2, a.addi2, a.monthnumber, a.daynumber, ".
...
//---------------------------------------------------------------------------------------------------------------------------------------------------
//CASE 1:  IF DAY1 AND DAY2 FOLLOWUP HAVE BEEN COMPLETED 
//DISPLAYS THE CASE AND THE FOLLOW-UP DATA

if (($spb['painscore1'] > -1 && $_SESSION['revise1'] == 0) && ($spb['painscore2'] > -1 && $_SESSION['revise2'] == 0))
{
    echo'
...
//---------------------------------------------------------------------------------------------------------------------------------------------------
//CASE 2:  IF DAY1 FOLLOW-UP HAS BEEN COMPLETED BUT NOT DAY 2 OR IF DAY 2 REVISION IS NECESSARY 



else if (($spb['painscore1'] > -1 && $_SESSION['revise1'] == 0) && ($spb['painscore2'] == -1 || $_SESSION['revise2'] == 1))
{
    echo'
    <h1 class="h1log" style="color:#000000">Followup: Day 1</h1>';
    if ($_SESSION['w'] > 925)
