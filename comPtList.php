...
<div class="row" style="background-color:#7db4dc;">
  ...
  <div class="w3-padding w3-center"><h1>Complete Patient List</h1></div>
</div>
...
<div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:130px">
  ...
  <button class="w3-bar-item w3-button tablink" onclick="openInfo(event, \'comPtList\')" id="defaultOpen">Complete Patient List</button>
...
echo'
<div id="comPtList" class="w3-container reg" style="display:none">
