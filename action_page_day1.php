...
{
    if (isset($_SESSION['pain1']))
       unset($_SESSION['painscore1']);
    if (isset($_SESSION['sensoryblock1']))
       unset($_SESSION['sensoryblock1']);
    if (isset($_SESSION['motorblock1']))
       unset($_SESSION['motorblock1']);
    if (isset($_SESSION['nsaids1']))
       unset($_SESSION['nsaids1']);
    if (isset($_SESSION['acetaminophen1']))
       unset($_SESSION['acetaminophen1']);
    if (isset($_SESSION['narcotics1']))
       unset($_SESSION['narcotics1']);
    if (isset($_SESSION['drainage1']))
       unset($_SESSION['drainage1']);
    if (isset($_SESSION['comments1']))
       unset($_SESSION['comments1']);
    
    $_SESSION['painscore1'] = $_POST['pain1'];
    $_SESSION['sensoryblock1'] = $_POST['sensoryblock1'];
    $_SESSION['motorblock1'] = $_POST['motorblock1'];
    $_SESSION['nsaids1'] = $_POST['nsaids1'];
    $_SESSION['acetaminophen1'] = $_POST['acetaminophen1'];
    $_SESSION['narcotics1'] = $_POST['narcotics1'];
    $_SESSION['drainage1'] = $_POST['drainage1'];
    $_SESSION['comments1'] = $_POST['comments1'];
...
echo'
    ...
    if ($_SESSION['sensoryblock1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
                <b>Sensory Block: </b>
    ...
    if ($_SESSION['motorblock1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
                <b>Motor Block: </b>
    ...
    if ($_SESSION['nsaids1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
                <b>NSAID Use: </b>
    ...
    if ($_SESSION['acetaminophen1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
    ...
    if ($_SESSION['narcotics1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
                <b>Narcotic Use: </b>
    ...
    if ($_SESSION['drainage1']  == 1){$z = 'Yes';} else {$z = 'No';}
    echo'
        <tr>
            <td style="width:50%; border:none; text-align:right; padding:10px">
                <b>Drainage: </b>
    ...
    function ce()
    {
        window.location="action_page_day1_2.php";
    }
    </script>
<?php
}
